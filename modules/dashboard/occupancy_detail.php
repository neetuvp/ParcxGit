...
?>
    ...
    <div class="content-wrapper">
      ...
      <div class="row text-dark" id="occupancy_content">
        <?php 
         $dashboard->OccupancyCarparkDetail($_SESSION['facility_number'],$_GET['carpark_number']);
        ?>          
                                        ...
                                        <div class="w-100 row m-0">
                                            <div class="col-4 ml-auto p-0">
                                                <select id="linechart-select">
                                                    <!-- value 0 - make sure value is unique -->
...
//Load the hourly occupancy graph on page load                 
hourlyOccupancy();   
