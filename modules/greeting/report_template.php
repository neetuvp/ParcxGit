                    ...
                    <div class="timeline-centered timeline-sm">
                        ...
                        <article class="timeline-entry left-aligned">
                            <div class="timeline-entry-inner">
                                ...
                                <div class="dropdown">
                                    <div class="timeline-icon bg-green stage"><i class="fa fa-group"></i>
                                        <div class="dropdown-content">
                                ...
                                <div class="timeline-label bg-green"><h4 class="timeline-title">Job Meeting</h4>
                                    ...
                                    <p>C 
                                        aulie dandelion maize lentil collard greens radish arugula sweet pepper water spinach kombu courgette.</p></div>
                            </div>
                        </article>
                        <article class="timeline-entry">
                            <div class="timeline-entry-inner">
