    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Vehicle Pictures</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="valet_pictures">
    ...
    $(document).on('click', '.view-img', function () {
        ...
        $.post("../../ajax/valet.php?task=3", temp)
                .done(function (result) {
                    ...
                    width=width*52/100;
                    width=width/2;                        
                    $('.modal-body img').width(width);
                    $('.modal-body img').height(width-150);                    
                }, "json");
