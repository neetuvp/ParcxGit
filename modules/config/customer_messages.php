            ...
            <div class="col">
              ...
              <?php
                ...
                echo '<table border=0>';               
				        ...
				        echo '<tr><td style = "width:50%">Device Type</td><td>';
                echo '<select name = "device_type" id = "device_type" class="form-control"><option value = "1">Entry</option><option value = "2">Exit</option><option value = "3">Cashier</option><option value = "4">APM</option><option value = "5">Handheld</option></select>';
                echo '</td></tr>';
        
                echo '<tr><td>Message</td><td>';
                echo '<input type= "text" class="form-control" name="message" id ="message"  value = ""/></td></tr>';
                echo '</td></tr>';
                ...
                echo '<tr><td>Upload Image</td><td>';
                echo "<input type='file' id='image_file' name='image_file' accept='image/*'>";
                echo '</td></tr>';           
                echo "<tr><td><button type='submit' class='btn btn-primary' id='add_message_btn' onclick = 'AddMessage(".json_encode($result).")'>Add Message</button></td></tr>";
                echo '</table>'
              ?>
                </div>
            </div>                        
