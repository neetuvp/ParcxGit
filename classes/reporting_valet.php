...
{  
 ...
 $html_data.="<td class='col'><a href='#' class='view-img' data-toggle='modal' data-target='#detailModal'  id=".$data['id'].">View Images</a></td>";
...
while($data_summary=mysqli_fetch_assoc($result)) {
    ...
    $html_data.='<img height="200" width="250" src="'.$imageurl.'" >';
...
function get_valet_car_pictures($id)
{
    ...
    $html_data.='<div class="front-image "> <img src='.$this->getImageUrl($data_summary["front_plate"]).'></div>'; //Neetu remove '$folder' from .IMAGEURL.$folder.$data_summary["front_plate"].'
    $html_data.='</div>';

    $html_data.= '<div class="car_image float-right  pt-4">';
    $html_data.='<div class="front-image"> <img src='.$this->getImageUrl($data_summary["right_plate"]).'></div>';
    $html_data.='</div>';

    $html_data.= '<div class="car_image float-left  pt-4">';
    $html_data.='<div class="front-image"> <img src='.$this->getImageUrl($data_summary["left_plate"]).'></div>';
    $html_data.='</div>';

    $html_data.= '<div class="car_image float-right  pt-4">';
    $html_data.='<div class="front-image"> <img src='.$this->getImageUrl($data_summary["back_plate"]).'></div>';
    $html_data.='</div>';
