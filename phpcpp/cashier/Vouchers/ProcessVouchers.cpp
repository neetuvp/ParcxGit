...
string log_file_path = "/opt/parcx/Logs/Services/ApplicationLogs/vouchers_phpcpp_"+ p.currentDate()+ "_log.log";
string error_file_path = "/opt/parcx/Logs/Services/ExceptionLogs/vouchers_phpcpp_"+ p.currentDate()+ "_exception.log";
