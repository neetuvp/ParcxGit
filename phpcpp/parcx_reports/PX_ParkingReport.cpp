...
void ParkingReport::openTransactionReport(Php::Value json)
    ...
    try
        ...
        if(res->rowsCount()>0)
            ...
            Php::out<<"<h6>"<<getLabel("transactions",lang)<<"</h6>"<<endl;
            Php::out<<"</div>"<<endl;            
            Php::out<<"</div>"<<endl;
            Php::out<<"</div>"<<endl;
            Php::out<<"</div>"<<endl;
            ...
            Php::out<<"<th>"<<getLabel("device_name",lang)<<"</th>"<<endl;	
             Php::out<<"<th>"<<getLabel("plate_number",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("ticket_id",lang)<<"</th>"<<endl;                       
            Php::out<<"<th>"<<getLabel("entry_type",lang)<<"</th>"<<endl;		            
            Php::out<<"<th>"<<getLabel("entry_date_time",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("duration",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("entry_grace_period",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("amount_paid",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("payment_date_time",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("exit_grace_period",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("image",lang)<<"</th>"<<endl;
            ...
            {
            Php::out<<"<div class='p-0'>"+getLabel("no_records",lang)+"</div>"<<endl;
            }
...
void ParkingReport::blacklistReport(Php::Value json)
    ...
    try
        ...
        if(res->rowsCount()>0)
            ...
            Php::out<<"<th>"<< getLabel("ticket_id",lang)<<"</th>"<<endl;    
            Php::out<<"<th>"<<getLabel("device_name",lang)<<"</th>"<<endl;	  
            Php::out<<"<th>"<<getLabel("blacklisting_reason",lang)<<"</th>"<<endl;             
            Php::out<<"<th>"<<getLabel("description",lang)<<"</th>"<<endl;	                      
			Php::out<<"</tr></thead>"<<endl;
			Php::out<<"<tbody>"<<endl;
            i=0;
            while(res->next())
...
void ParkingReport::validationReport(Php::Value json)
    ...
    try
        ...
        if(res->rowsCount()>0)
            ...
            Php::out<<"<th>"<<getLabel("plate_number",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("ticket_id",lang)<<"</th>"<<endl;    
            Php::out<<"<th>"<<getLabel("validator",lang)<<"</th>"<<endl;                                            
            Php::out<<"<th>"<<getLabel("product",lang)<<"</th>"<<endl;	                                  
			Php::out<<"</tr></thead>"<<endl;
			Php::out<<"<tbody>"<<endl;
            i=0;
            while(res->next())
...
void ParkingReport::accessReport(Php::Value json)
    ...
    try
        ...
        if(res->rowsCount()>0)
            ...
            Php::out<<"<th>#</th>"<<endl;             
            Php::out<<"<th>"<<getLabel("date_time",lang)<<"</th>"<<endl;    
            Php::out<<"<th>"<<getLabel("customer_name",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("plate_number",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("ticket_id",lang)<<"</th>"<<endl;                   
            Php::out<<"<th>"<<getLabel("tag",lang)<<"</th>"<<endl;                                                   
            Php::out<<"<th>"<<getLabel("status",lang)<<"</th>"<<endl;                                            
            Php::out<<"<th>"<<getLabel("device_name",lang)<<"</th>"<<endl;	  
            Php::out<<"<th>"<<getLabel("carpark_name",lang)<<"</th>"<<endl;            	  
            Php::out<<"<th></th>"<<endl;
			Php::out<<"</tr></thead>"<<endl;
			Php::out<<"<tbody>"<<endl;
            i=0;
...
void ParkingReport::visitorFrequencyReport(Php::Value json)
	...
	try
        ...
        if(res->rowsCount()>0)			
            ...
            {
            Php::out<<"<div class='p-0'>No records</div>"<<endl;
            }
...
void ParkingReport::visitorFrequencyRealTimeReport(Php::Value json)
    ...
    try
        ...
        if(res->rowsCount()>0)			
            ...
            Php::out<<"<th>"<<getLabel("plate_number",lang)<<"</th>"<< std::endl;
            Php::out<<"<th>"<<getLabel("ticket_id",lang)<<"</th>"<< std::endl;			
			if(visit_type=="contract")			
				Php::out<<"<th>"<<getLabel("tag",lang)<<"</th>"<< std::endl;
			
            Php::out<<"<th>"<<getLabel("no_of_visits",lang)<<"</th>"<< std::endl;
            Php::out<<"</tr></thead>"<<endl;
			Php::out<<"<tbody>"<<endl;  
			n=1;
...
void ParkingReport::ticketDetails(Php::Value json)
    ...
    try
        ...
        if(entry_type!=0)
            {               
            Php::out<<getLabel("status",lang)<<": "<<status<<"<br>"<<endl;    
            Php::out<<"<h3>"<<getLabel("entry_details",lang)<<"</h3>"<<endl;
            Php::out<<""<<getLabel("entry_type",lang)<<": "<<type<<"<br>"<<endl;           
            Php::out<<""<<getLabel("plate_number",lang)<<": "<<plate_number<<"<br>"<<endl;
            Php::out<<""<<getLabel("entry_date_time",lang)<<": "<<entry_date_time<<"<br>"<<endl;    
            Php::out<<""<<getLabel("entry_grace_period",lang)<<": "<<entry_grace_period<<"<br>"<<endl;       
            Php::out<<""<<getLabel("entry_device_name",lang)<<": "<<entry->getString("device_name")<<"<br>"<<endl;          
            Php::out<<""<<getLabel("entry_carpark_name",lang)<<": "<<entry->getString("carpark_name")<<"<br>"<<endl;

            delete entry;

            if(entry_type==2 && access->rowsCount()>0)
                {
                Php::out<<"<h3>"<<getLabel("access_details",lang)<<"</h3>"<<endl; 
                Php::out<<""<<getLabel("customer_name",lang)<<": "<<access->getString("customer_name")<<"<br>"<<endl;   
                Php::out<<""<<getLabel("validity_start_date",lang)<<": "<<access->getString("validity_start_date")<<"<br>"<<endl;   
                Php::out<<""<<getLabel("validity_expiry_date",lang)<<": "<<access->getString("validity_expiry_date")<<"<br>"<<endl;    
                delete access;               
                }

            if(entry_type==3 && reservation->rowsCount()>0)
                {
                Php::out<<"<h3>"<<getLabel("reservation_details",lang)<<"</h3>"<<endl; 
                Php::out<<""<<getLabel("customer_name",lang)<<": "<<reservation->getString("name")<<"<br>"<<endl;   
                Php::out<<""<<getLabel("validity_start_date",lang)<<": "<<reservation->getString("from_time")<<"<br>"<<endl;   
                Php::out<<""<<getLabel("validity_expiry_date",lang)<<": "<<reservation->getString("to_time")<<"<br>"<<endl;    
                delete reservation;               
                }

            if(amount_paid!="")
                {
                Php::out<<"<h3>"<<getLabel("payment_details",lang)<<"</h3>"<<endl;
                if(payment->next())
                    {
                    Php::out<<""<<getLabel("payment_date_time",lang)<<": "<<payment->getString("payment_date_time")<<"<br>"<<endl;    
                    Php::out<<""<<getLabel("maximum_exit_date_time",lang)<<": "<<payment->getString("max_exit_date_time")<<"<br>"<<endl;                   
                    Php::out<<""<<getLabel("payment_device_name",lang)<<": "<<payment->getString("device_name")<<"<br>"<<endl;          
                    Php::out<<""<<getLabel("payment_carpark_name",lang)<<": "<<payment->getString("carpark_name")<<"<br>"<<endl;   
                    Php::out<<""<<getLabel("amount_paid",lang)<<": "<<payment->getString("gross_amount")<<"<br>"<<endl;   
                    if(payment->getInt("discount_id")!=0)
                        {
                        Php::out<<""<<getLabel("discount_name",lang)<<": "<<payment->getString("discount_name")<<"<br>"<<endl;       
                        }
                    if(payment->getString("validation_id")!="" && payment->getString("validation_id")!="0")
                        {
                        Php::out<<""<<getLabel("validation_value",lang)<<": "<<payment->getString("validation_value")<<"<br>"<<endl;       
                        }
                    delete payment;
                    }
                }
            ...
            if(exit_date_time!="")
                {
                Php::out<<"<h3>"<<getLabel("exit_details",lang)<<"</h3>"<<endl;
                Php::out<<""<<getLabel("exit_time",lang)<<": "<<exit_date_time<<"<br>"<<endl;                   
                Php::out<<""<<getLabel("exit_device_name",lang)<<": "<<exit->getString("device_name")<<"<br>"<<endl;          
                Php::out<<""<<getLabel("exit_carpark_name",lang)<<": "<<exit->getString("carpark_name")<<"<br>"<<endl;
                delete exit;
                }

            }
        else
            Php::out<<""<<getLabel("invalid_ticket",lang)<<""<<endl;            
...
void ParkingReport::watchdogNetworkLogs(Php::Value json)
    ...
    try 
        ...
        if(res->rowsCount()>0)
            ...
            Php::out<<"<th></th>"<<endl;                                               
            Php::out<<"<th>"<<getLabel("device_name",lang)<<"</th>"<<endl;	  
            Php::out<<"<th>"<<getLabel("ip_address",lang)<<"</th>"<<endl;  
            Php::out<<"<th>"<<getLabel("connection_lost",lang)<<"</th>"<<endl;                         
	    Php::out<<"<th>"<<getLabel("connection_restored",lang)<<"</th>"<<endl;	     
            Php::out<<"<th>"<<getLabel("carpark_name",lang)<<"</th>"<<endl;	     
            Php::out<<"</tr></thead>"<<endl;
            Php::out<<"<tbody>"<<endl;
            while(res->next())
...
void ParkingReport::watchDogDeviceAlarms(Php::Value json)
    ...
    try
        ...
        if(res->rowsCount()>0)
            {
            string labels="date_time,device_name,severity,description,high,medium,low";
		...
		Php::out<<"<tr>"<<endl;                                
                ...
                if(res->getInt("alarm_severity")>=4 && res->getInt("alarm_severity")<=7)
                    Php::out<<"<td><span class='badge badge-warning'>"<<label["medium"]<<"</span></td>"<<endl; 
                if(res->getInt("alarm_severity")>=8 && res->getInt("alarm_severity")<=10)
...
void ParkingReport::manualmovementReport(Php::Value json)
{
    try
        ...
        if(res->rowsCount()>0)
            ...
            Php::out<<"<th>"<<getLabel("date_time",lang)<<"</th>"<<endl;                         
            Php::out<<"<th>"<<getLabel("device_name",lang)<<"</th>"<<endl;	  
            Php::out<<"<th>"<<getLabel("operator_name",lang)<<"</th>"<<endl;             
            Php::out<<"<th>"<<getLabel("action",lang)<<"</th>"<<endl;
            Php::out<<"<th>"<<getLabel("reason",lang)<<"</th>"<<endl;
	    Php::out<<"<th>"<<getLabel("description",lang)<<"</th>"<<endl;	     
            Php::out<<"</tr></thead>"<<endl;
            Php::out<<"<tbody>"<<endl;
...
void ParkingReport::platescapturedReport(Php::Value json)
    ...
    try
        ...
        if(toString(json["device"])!="0")
              query = query+" and camera_device_number='"+toString(json["device"])+"'";
            ...
            if(toString(json["country"])!="")
               query = query+" and plate_count[24]ry = '"+toString(json["country"])+"'";
        ...
        if(res->rowsCount()>0)
			...
			Php::out<<"<thead><tr>"<<endl;
            Php::out<<"<th></th>"<<endl;    
			Php::out<<"<th>"<<getLabel("camera_name",lang)<<"</th>"<<endl;  
            Php::out<<"<th>"<<getLabel("date_time",lang)<<"</th>"<<endl;                         
            Php::out<<"<th>"<<getLabel("plate_number",lang)<<"</th>"<<endl;    
            Php::out<<"<th>"<<getLabel("plate_area",lang)<<"</th>"<<endl;	  
            Php::out<<"<th>"<<getLabel("plate_count[24]ry",lang)<<"</th>"<<endl;             
            Php::out<<"<th>"<<getLabel("cropped_image",lang)<<"</th>"<<endl;	  
			Php::out<<"<th>"<<getLabel("full_image",lang)<<"</th>"<<endl;	  
			Php::out<<"</tr></thead>"<<endl;
			Php::out<<"<tbody>"<<endl;
            i=0;
            while(res->next())
                ...
                Php::out<<"<td>"+res->getString("plate_count[24]ry")+"</td>"<<endl;    
...
void ParkingReport::getanprImage(Php::Value json)
{
	...
	Php::out<<"<img src ='"+ImageURL+"\\"+camera_id+"\\"+plate_date+"\\Scene_"+plate_image+"' width='1000'; height='700';>"<<endl;;
	Php::out<<"</div>"<<endl;
...
//Php::out<<from<<endl;
		...
		if(carpark.length()>0)
		   query = query+" AND carpark_id IN '"+carpark+"'";
	    ...
	    if(res->rowsCount()>0)
        {
            ...
            summary += "     <p>"+getLabel("entries",lang)+"<br>["+getLabel("short_term",lang)+"]</p>";
            summary += "    </div>";
            ...
            summary += "    <p>"+getLabel("exits",lang)+"<br>["+getLabel("short_term",lang)+"]</p>";
            summary += "  </div>";
            summary += "  <div class='icon'>";
            summary += "  <i class='ion ion-pie-graph'></i>";
            summary += "  </div>";   
            ...
            summary += "   <p>"+getLabel("manual_operation",lang)+"<br>"+getLabel("entry_exit",lang)+"</p>";
            summary += " </div>";
            summary += " <div class='icon'>";
            summary += " <i class='ion ion-pie-graph'></i>";
            summary += " </div>";        
            ...
            if(show_date_by_report==true)
            {
                ...
                header += "<thead><tr><th>"+getLabel("report_date",lang)+"</th>";            
                header += "<th>"+getLabel("shortterm_entries",lang)+"</th>";
                header += "<th>"+getLabel("shortterm_exits",lang)+"</th>";
                header += "<th>"+getLabel("contract_entries",lang)+"</th>";
                header += "<th>"+getLabel("contract_exits",lang)+"</th>";
                header += "<th>"+getLabel("manual_entry",lang)+"</th>";
                header += "<th>"+getLabel("manual_exit",lang)+"</th>";            
                header += "</tr></thead>";
                //Php::out<<header<<endl;
				html_data+=header;
                html_data+="<tbody>";
                ...
                html_data += "<tr>";            
                html_data += "<td>"+getLabel("total",lang)+"</td>";                   
				...
				header += "<th>"+getLabel("from",lang)+"</th>";
				header += "<th>"+getLabel("to",lang)+"</th>";
				header += "<th>"+getLabel("shortterm_entries",lang)+"</th>";
				header += "<th>"+getLabel("shortterm_exits",lang)+"</th>";
				header += "<th>"+getLabel("contract_entries",lang)+"</th>";
				header += "<th>"+getLabel("contract_exits",lang)+"</th>";
		...
		{
			Php::out<<"<div class='card p-3'>"+getLabel("no_records",lang)+"</div>"<<endl;
		}        
        //echo html_data;   
