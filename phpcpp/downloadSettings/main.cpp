...
Php::Value downloadSettings(string device_number)
{
	...
	if(res->next())
		...
		// 	{
		// 	jsonrow["anpr_enabled"]=string(res->getString("anpr_enabled"));	
		// 	jsonrow["wiegand_enabled"]=string(res->getString("wiegand_enabled")); 		
		// 	jsonrow["access_enabled"]=string(res->getString("access_enabled"));
		// 	jsonrow["access_enabled"]=string(res->getString("qrcode_access_enabled"));        
		// 	jsonrow["reservation_enabled"]=string(res->getString("reservation_enabled"));    
		// 	jsonrow["device_function"]=string(res->getString("device_function"));      
		// 	}	
