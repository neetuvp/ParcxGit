//g++ -std=c++11 -Wall -o PX_CloudDownload_V01_03_02_20210131 PX_CloudDownload_V01_03_02_20210131.cpp PX_GeneralOperations.cpp -ljsoncpp -lmysqlcppconn -lcurl -I/opt/lampp/include/ -L/opt/parcx/lib/ -pthread
...
int main(void) {
    ...
    if (rc) {
        ...
        pid = fork();        
        if (pid > 0) {
            WriteToLog("Main: ", "Cloud Download Daemon Version : PX_CloudDownload_V01_03_02_20210131    Process Id:" + to_string(pid));
            cout << "PX_CloudDownload_V01_03_02_20210131" << "Process Id :" << pid << endl;
