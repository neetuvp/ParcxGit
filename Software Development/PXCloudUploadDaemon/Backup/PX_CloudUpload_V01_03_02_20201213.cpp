 //sudo g++ -std=c++11 -Wall -o PX_CloudUpload_V01_03_02_20201213 PX_CloudUpload_V01_03_02_20201213.cpp PX_GeneralOperations.cpp -ljsoncpp -lmysqlcppconn -lpthread -lcurl -I/opt/lampp/include/ -L/opt/parcx/lib/
    ...
    try
    {
        ...
        if(res->rowsCount()>0)
        {
            while(res->next())
            {
                ...
                row["validation_hours"]= res->getInt("validation_hours");
                row["validation_transactions"]= res->getString("validation_transactions").asStdString();
    ...
    try{
		...
		if(rowcount>0)
		{
			while(rs->next())
			{
                ...
                duration["dayclosure"] =rs->getInt("dayclosure"); 
...
int main(void)
	...
	if(rc) 
        ...
        if(pid > 0)
            {
			WriteToLog("Main: " , "Cloud Upload Daemon Version : PX_CloudUpload_V01_03_02_20201213    Process Id:"+to_string(pid));
			cout<<"Cloud Upload Daemon Version : PX_CloudUpload_V01_03_02_20201213"<<"Process Id :"<<pid<<endl;	
