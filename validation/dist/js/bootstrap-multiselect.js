! function (t) {
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        defaults: {
            ...
            enableHTML: !1,
            buttonClass: "btn multiselect-btn-default",
            inheritClass: !1,
            buttonWidth: "auto",
            ...
            templates: {
                ...
                filterClearBtn: '<span class="input-group-btn"><button class="btn multiselect-btn-default multiselect-clear-filter" type="button"><i class="glyphicon glyphicon-remove-circle"></i></button></span>',
