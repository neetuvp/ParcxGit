...
if($_SERVER['REQUEST_METHOD']=='POST')
	...
	$reservation_response=getReservationDetails($ticket_no,$reservation_entry_grace_period,$reservation_exit_grace_period,$carpark,$facility,$device_type,$parking_zone);		
